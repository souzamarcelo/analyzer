...
cs.add_hyperparameter(hp.UniformFloatHyperparameter('param_a', lower=0.0, upper=1.0))
cs.add_hyperparameter(hp.UniformFloatHyperparameter('param_b', lower=0.0, upper=1.0))
cs.add_hyperparameter(hp.UniformFloatHyperparameter('param_c', lower=0.0, upper=1.0))
cs.add_hyperparameter(hp.UniformFloatHyperparameter('param_d', lower=0.0, upper=1.0))
