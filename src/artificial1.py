...
class Artificial1:
    ...
    def create(self):
        ...
        self.parameters.append(Parameter('param_b', '-b', Type.REAL, [0, 1], 'param_a <= 0.2'))
        self.parameters.append(Parameter('param_c', '-c', Type.REAL, [0, 1], 'param_a >= 0.1 and param_a <= 0.3'))
        self.instances = []
