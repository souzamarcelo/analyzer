...
class Artificial2:
    ...
    def create(self):
        ...
        self.parameters.append(Parameter('param_b', '-b', Type.REAL, [0, 1], 'param_a <= 0.95'))
        self.parameters.append(Parameter('param_c', '-c', Type.REAL, [0, 1]))
        self.parameters.append(Parameter('param_d', '-d', Type.REAL, [0, 1], 'param_c <= 0.05'))
        self.instances = []
    ...
    def get_random_configuration(self):
        ...
        for param in self.parameters:
            if param.type == Type.CATEGORICAL:
                ...
                values.append((((param.domain[1] - param.domain[0]) * random.random()) + param.domain[0]))
