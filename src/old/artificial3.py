...
class Artificial:
    ...
    def create(self):
        ...
        self.parameters.append(Parameter('param_b', '-b', Type.REAL, [0, 1], 'param_a >= 0.5 and param_a <= 0.7'))
        self.parameters.append(Parameter('param_c', '-c', Type.REAL, [0, 1], 'param_b <= 0.1'))
        self.instances = []
