...
class Artificial:
    ...
    def create(self):
        ...
        self.parameters.append(Parameter('param_b', '-b', Type.REAL, [0, 1], 'param_a <= 0.3'))
        self.parameters.append(Parameter('param_c', '-c', Type.REAL, [0, 1], 'param_a >= 0.8'))
        self.parameters.append(Parameter('param_d', '-d', Type.REAL, [0, 1], 'param_c >= 0.8'))
        self.instances = []
